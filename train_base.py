...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str,
                        default='CNN_1d', help='the name of the model')
    ...
    parser.add_argument('--checkpoint_dir', type=str,
                        default='./checkpoint_adabn', help='the directory to save the model')
    ...
    parser.add_argument('--print_step', type=int, default=600,
